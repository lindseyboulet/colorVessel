...
filename = askopenfilename(filetypes=[("JPG", "*.jpg"), ("PNG", "*.png"), ("All files", "*")]) # show an "Open" dialog box and return the path to the selected file
...
cv2.createTrackbar('cut1','select_vessel_length',0, 25,callback)
